import ImagePlaceholder from "./../assets/AnimImage/Placeholder.json";
...
const SliderSkeleton = () => {
  return (
    <div className=" bg-gray-300 flex mt-16 md:mt-28  justify-center p-2 md:p-4 font-sans">
      <div className=" container bg-white rounded-lg shadow-xl p-2 md:p-6 animate-pulse">
        <div className="w-full md:h-[550px] bg-gray-100 rounded-md mb-2 md:mb-6 grid grid-cols-2 justify-center items-center">
          ...
          <div className="flex justify-center items-center p-2 md:p-4 lg:p-10">
            <Lottie
              className="lg:w-3/4"
