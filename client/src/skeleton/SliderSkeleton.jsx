...
const SliderSkeleton = () => {
  return (
    <div className=" bg-gray-300 flex mt-16 md:mt-28  justify-center p-2 md:p-4 lg:p-10 font-sans">
      <div className="w-full animate-pulse">
        <div className="w-full md:h-[50vh] bg-gray-100 rounded-md mb-2 md:mb-6 grid grid-cols-2 justify-center items-center">
