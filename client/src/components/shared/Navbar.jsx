...
import { FaPhoneVolume, FaRegHeart, FaTwitter, FaYoutube } from "react-icons/fa6";
    ...
    <header className="fixed w-full top-0 z-50">
      ...
      <nav className="bg-white shadow-md py-4 px-6 flex items-center justify-between">
        <div className="flex items-center space-x-8">
          ...
          <a href="#" className="text-gray-700 hover:text-[#fc5c65] font-medium">Home</a>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="relative flex items-center">
            ...
            />
            <button className="bg-white border border-l-0 border-gray-300 text-gray-500 py-2 px-4 rounded-r-md hover:bg-gray-100">
              <CiSearch size={20} />
            </button>
          </div>
          ...
          <button className="relative text-gray-700 hover:text-[#fc5c65]">
            ...
            <span className="absolute -top-1 -right-1 bg-[#fc5c65] text-white text-xs rounded-full h-4 w-4 flex items-center justify-center">0</span>
          </button>
